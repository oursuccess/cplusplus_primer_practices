...
//define classes:
//TextQuery : read the text and build a StrVec of all the words , and tag their lines
//read file -- use StrVec to save -- save as an map:word and their appear lines
...
class QueryResult{
	public:
		//constructor
		QueryResult(string, shared_ptr<set<unsigned>>, shared_ptr<StrVec>);
